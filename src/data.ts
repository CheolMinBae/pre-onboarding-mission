export const dummy = [{
  'description': '(ORCL) Oracle Corp',
  'key': 'Oracle Corp',
  'type': 'COMPANY'
}, {'description': '(AAPL) Apple Inc', 'key': 'Apple Inc', 'type': 'COMPANY'}, {
  'description': '(GOOG) Google Inc',
  'key': 'Google Inc',
  'type': 'COMPANY'
}, {
...
export const typeSectionData = dummy.reduce((a, b) => {
  if (a.hasOwnProperty(b.type)) {
    (a[b.type] as typeof dummy).push(b)
  } else {
    a[b.type] = [b]
  }

  return a;
}, {} as Record<string, typeof dummy>)
